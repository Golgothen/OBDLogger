...
def loadDefaults():
    ...
    config.set('Data Screen','Line 3','FAM')
    config.set('Data Screen','Line 4','ENGINE_LOAD')
    config.set('Data Screen','Line 5','MAF')
    config.set('Data Screen','Line 6','DISTANCE')
    config.set('Data Screen','Line 7','DURATION')
    config.set('Data Screen','Line 8','LPS')
