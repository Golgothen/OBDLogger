...
def loadDefaults():
    ...
    config.set('Data Layout','EGR',            '***EGR : CONNANDED_EGR.VAL/EGR_ERROR.VAL :')
    config.set('Data Layout','AIR_TEMP',       '*Air C : AMBIANT_AIR_TEMP.VAL/AMPIANT_AIR_TEMP.MAX :')
    config.set('Data Layout','INTAKE_TEMP',    'Intake : INTAKE_TEMP.VAL/INTAKE_TEMP.MAX :')
    config.set('Data Layout','FUEL_RAIL',      '*Air C : FUEL_RAIL_PRESSURE_DIRECT.VAL/FUEL_RAIL_PRESSURE_DIRECT.MAX :')
